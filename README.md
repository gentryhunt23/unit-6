This is a weather web application. When a city is typed into the search bar and the button is clicked, the weather data for that particular city populates onto the screen. 
